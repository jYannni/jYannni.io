...
export default async function BlogsPage() {
  ...
  const featured = allBlogs.find((blog) => blog.slug === "Introduction-to-Frontend-Development")!;
  const top2 = allBlogs.find((blog) => blog.slug === "React-and-AI")!;
  const top3 = allBlogs.find((blog) => blog.slug === "first-post")!;
