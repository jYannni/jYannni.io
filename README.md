<div align="center">
    <a href="https://chronark.com"><h1 align="center">jyannni.io</h1></a>

My personal website, built with [Next.js](https://nextjs.org/), [Tailwind CSS](https://tailwindcss.com/), [Upstash](https://upstash.com?ref=chronark.com), [Contentlayer](https://www.contentlayer.dev/) and deployed to [Vercel](https://vercel.com/). I've used [Chronark](https://chronark.com) as a template - many thanks to him and all those that have contributed to the site.
